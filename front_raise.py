...
GAINS = {
	...
	"ankle": {"kp": 900.0, "kd": 50.0},
	"waist": {"kp": 1000.0, "kd": 60.0},
	"arm": {"kp": 220.0, "kd": 8.0},
...
FRONT_RAISE_POSE = {
	...
	"left_wrist_pitch_joint": 0.00,
	"left_wrist_yaw_joint": 0.00,
	"right_shoulder_pitch_joint": -1.55,
...
START_HOLD_S = 1.0
RAISE_S = 5.0   # slower raise for stability
TOP_HOLD_S = 0.8
LOWER_S = 5.0   # slower lower
REST_HOLD_S = 0.8
...
def main():
	...
	q_raise = build_desired_pose(model, FRONT_RAISE_POSE)
	...
	print("Starting viewer: repeating stand -> raise -> lower front-raise loop.")
